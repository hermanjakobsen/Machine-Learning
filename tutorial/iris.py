...
#print(dataset.head(20))                 # Print 20 rows
#print(dataset.describe())               # Statistics
#print(dataset.groupby('class').size())  # Class distribution

# Univariate (individual variable) plots of dataset
#dataset.plot(kind='box', subplots=True, layout=(2,2), sharex=False, sharey=False)   # Box and whisker plots
#dataset.hist()  # Histograms
#pyplot.show()

# Mulitvariate plots of dataset - Interactions between variables
